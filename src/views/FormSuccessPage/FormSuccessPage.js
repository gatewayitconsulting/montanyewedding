                ...
                <div className={classes.contactContent}>
                    <div className={classes.container}>
                        ...
                        <GridContainer>
                            ...
                            >
                                <h3 className="vertical-timeline-element-title">Thank you for your RSVP!</h3>
                                <h4 className="vertical-timeline-element-subtitle">We can't wait to share our big day with you!</h4>
                            </GridItem>
                        </GridContainer>
                    </div>
                </div>
